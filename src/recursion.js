...
var exponent = function(base, exp) {
  ...
  if (exp < 1) return (1 / exponent(base, -exp));
...
// powerOfTwo(16); // true
// powerOfTwo(10); // false
// :: If recursion seems to be written right, but failing, check for more detailed base cases
// :: [first] is wrapped in a base case in this function
